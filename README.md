...
| [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) | Colorscheme engine (custom palette applied) |
| [catppuccin/nvim](https://github.com/catppuccin/nvim) | Alternative colorscheme (switch in `colorscheme.lua`) |
...
|---|---|
| `colorscheme.lua` | Sets the active colorscheme |
| `tokyonight.lua` | Colorscheme engine with a custom palette applied |
| `catppuccin.lua` | Alternative colorscheme |
