...
local battery_percent = SBAR.add("item", {
  ...
  icon = { string = "Percentage:", width = 160, align = "left", font = { size = 14.0 } },
  label = { string = "??%", width = 70, align = "right", font = { size = 14.0 } },
})

local remaining_time = SBAR.add("item", {
  position = "popup." .. battery.name,
  icon = { string = "Time remaining:", width = 160, align = "left", font = { size = 14.0 } },
  label = { string = "??:??h", width = 70, align = "right", font = { size = 14.0 } },
})
